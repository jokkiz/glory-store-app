...
class EditProfileForm(Form):
    ...
    middle_name = StringField('Отчество', validators=[Required(),
                                                      Length(1, 128,
...
class EditProfileAdminForm(Form):
    ...
    first_name = StringField('Имя', validators=[Required(), Length(1, 128, message="Имя должно быть от 1 до 128 символов")])
    last_name = StringField('Фамилия', validators=[Required(), Length(1, 128, message="Фамилия должна быть от 1 до 128 символов")])
    middle_name = StringField('Отчество', validators=[Length(1, 128, message="Отчество должно быть от 1 до 128 символов")])
    birthday = DateField('День рождения', format='%Y-%m-%d')
    about_me = TextAreaField('Обо мне')
    location = StringField('Местонахождение', validators=[Length(3, 64,
                                                                 message="Длина местонахождения должна быть от 3 до 64 символов")])
